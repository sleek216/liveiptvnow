@extends('layouts.app')
@section('title', 'Access Forbidden — Live IPTV Now')

@section('content')
<section class="error-page-sec">
    <div class="wrap text-center">
        <div class="error-hero text-center" data-aos="fade-up">
            <div class="error-badge error-badge-403">
                <i class="ri-lock-2-line"></i>
                <span>403 — {{ __('Access Forbidden') }}</span>
            </div>
            <h1 class="error-title">
                {{ __('Restricted Area') }} <span class="gradient-text">{{ __('Access Denied') }}</span>
            </h1>
            <p class="error-sub">
                {{ __("You don't have permission to view this resource. If you believe this is an error, please contact our support team.") }}
            </p>
            ...
            <div class="error-actions-hero">
                ...
                <a href="{{ route('contact') }}" class="btn-ghost-action">
