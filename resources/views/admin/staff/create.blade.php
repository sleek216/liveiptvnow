...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Create a new admin or employee account.</p>
        </div>
                    ...
                    <form action="{{ route('admin.staff.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror" value="{{ old('designation') }}" placeholder="e.g. Support Agent">
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" type="checkbox" role="switch" name="is_super_admin" id="isSuperAdmin" value="1" {{ old('is_super_admin') ? 'checked' : '' }} onchange="togglePermissions(this.checked)">
                                            ...
                                            <div class="card-body p-3">
                                                ...
                                                @foreach($sectionModules as $key => $module)
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="admin_modules[]" value="{{ $key }}" id="mod_{{ $key }}" {{ in_array($key, old('admin_modules', [])) ? 'checked' : '' }}>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-save me-1"></i>Create Staff Member
                            </button>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    // Run on load to set correct state if validation fails
